...
<html lang="en">
  ...
  <body class="nav-md">
          ...
          <div class="">
            ...
            <div class="row" style="display: block;">
              ...
              <div class="col-md-12 col-sm-12  ">
                <div id="x_content" class="x_panel">
                  <div class="x_title">
                    <h2>CRUD DATA </h2>
                  </div>
                    <div class="x_content" >
                      <a href="{{ route('crud.create') }}" class="submenu">Tambah</a>
   ...
   <script src="{{ asset('/storage/vendors/bootstrap/dist/js/bootstrap.bundle.min.js') }}"></script>
    ...
    $('#x_content').on('click', '.submenu', function(e) {
      e.preventDefault();
      $('#data_content').load($(this).attr('href'));
    });


    $('#x_content').on('click', '.delete', function(e) {
      e.preventDefault();
      if (confirm('Anda yakin ingin menghapus user tersebut?')) {
        $.ajax({
          headers: {
            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
          },
